...
This is a Spring Boot microservice that represents account information in a banking app. It uses the Fabric8 Maven Plugin to deploy to OpenShift.
...
```
curl http://account-<project>.<domain>/api/accounts
```
For example:
